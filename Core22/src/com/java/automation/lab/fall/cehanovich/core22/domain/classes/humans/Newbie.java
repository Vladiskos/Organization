...
public class Newbie extends Employee {
    private com.java.automation.lab.fall.cehanovich.core22.domain.enums.Position position;

    public Newbie(int id, String firstname, String lastname, String gender, int age, int experience,
